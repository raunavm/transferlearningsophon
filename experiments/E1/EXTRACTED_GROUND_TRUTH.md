...
| D6 | weaver in container | Image `escheuller/transfer-learning:cu121` weaver commit unknown. | Probe job pins `pip install 'git+https://github.com/hqucms/weaver-core.git@dev/custom_train_eval'` and records `pip show weaver-core`. |
